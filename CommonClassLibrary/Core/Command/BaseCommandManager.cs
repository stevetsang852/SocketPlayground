...
namespace CommonClassLibrary.Core.Command
{

    public class BaseCommandManager<T> : SingletonBase<T> where T : SingletonBase<T>, new()
    {
        ...
        protected void Init() // Task Mapping 
        {
